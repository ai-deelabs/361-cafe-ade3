...
Layered scroll composition with stacked horizontal text bands and offset image cards on a modular grid — expressive transitional serif paired with hairline caps — off-white linen + carbon black + dusty rose ash — quiet sophistication, slow and tactile
