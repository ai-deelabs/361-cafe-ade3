...
Brand:
361 Cafe is a modern cafe with a black and white, bright aesthetic.

This is variant 3 of 3.

CREATIVE DIRECTION
A creative director has chosen this direction for variant #3:
Kinetic single-column layout with text and imagery colliding at unexpected angles, heavy use of negative space — brutalist slab serif with tracked-out lowercase labels — glacier white + matte charcoal + faded umber — raw and intentional, caffeinated restlessness
